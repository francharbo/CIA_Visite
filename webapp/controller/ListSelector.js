sap.ui.define([
		...
		return BaseObject.extend("fr.ar.cia.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias fr.ar.cia.model.ListSelector
			 */
			 ...
			 * @return {fr.ar.cia.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
