sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("fr/ar/cia/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("fr.ar.cia.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["fr/ar/cia/localService/mockserver"], function (mockserver) {
